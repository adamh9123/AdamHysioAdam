...
import { UserPlus, RotateCcw, Clock, FileText, Zap, Stethoscope } from 'lucide-react';

export interface SessionTypeOption {
  id: 'intake' | 'intake-plus' | 'consult';
  title: string;
  description: string;
...
export interface SessionTypeSelectorProps {
  onSessionTypeSelect: (sessionType: 'intake' | 'intake-plus' | 'consult') => void;
  disabled?: boolean;
  className?: string;
}
...
const sessionTypes: SessionTypeOption[] = [
  {
    id: 'intake',
    title: 'Hysio Intake',
    description: 'Snelle intake voor casussen',
    icon: Zap,
    estimatedTime: '20-30 min',
    features: [
      'Start → Opnemen → Klaar',
      'Automatische HHSB structurering',
      'Volledige analyse na opname',
  ...
  {
    id: 'intake-plus',
    title: 'Hysio Intake Plus',
    description: 'Uitgebreide intake voor complexe casussen',
    icon: UserPlus,
    estimatedTime: '30-60 min',
    features: [
      '3-fase intake workflow',
      'Casus specifieke voorbereidingen',
      'HHSB anamnesekaart',
      'Evidence-based diagnostiek',
      'Gestructureerd onderzoeksbevinding',
  ...
  },
  {
    id: 'consult',
    title: 'Hysio Consult',
    description: 'Vervolgconsulten volgens SOEP-methodiek',
    icon: Stethoscope,
    estimatedTime: '20-30 min',
    features: [
      'Start → Opnemen → Klaar',
      'Professionele SOEP documentatie',
      'Algemene Samenvatting Consult',
      'Razendsnelle verslaglegging',
      'Optionele voorbereiding',
    ],
  },
];
