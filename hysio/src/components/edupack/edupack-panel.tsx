...
import { EduPackLoadingAnimation } from './loading-animation';
...
function GeneratingStep() {
  return (
    <div className="flex-1 flex items-center justify-center min-h-[400px] bg-gradient-to-br from-gray-50 to-white">
      <EduPackLoadingAnimation
        message="Uw gepersonaliseerde EduPack wordt gegenereerd met de nieuwste AI-technologie..."
      />
    </div>
  );
}
