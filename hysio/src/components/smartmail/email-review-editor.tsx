...
import {
  ...
  Clock, FileText, Sparkles, RefreshCw, Copy, Mail
} from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isEditingSubject ? 'Opslaan' : 'Bewerk'}
              </Button>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-0">
          {isEditingSubject ? (
            <Input
              ...
              autoFocus
              className="text-base font-medium border-blue-300 focus:border-blue-500"
              placeholder="Voer onderwerp in..."
            />
          ) : (
            <div className="p-3 bg-white border border-blue-200 rounded-md">
              <p className="text-base font-medium text-gray-900">{editedSubject || 'Geen onderwerp'}</p>
            </div>
          )}
        </CardContent>
      </Card>
