  ...
  ({ 
    ...
    return (
      <div
        ref={containerRef}
        className={cn(
          'flex h-full w-full bg-hysio-off-white',
          className
        )}
        {...props}
      >
        ...
        <div
          className={cn(
            'flex flex-col bg-white border-r border-hysio-mint/20',
            leftPanelClassName
          )}
        ...
        {resizable && (
          <div
            className={cn(
              'w-1 bg-hysio-mint/20 hover:bg-hysio-mint/40 cursor-col-resize transition-colors flex-shrink-0',
              isResizing && 'bg-hysio-mint/60'
            )}
