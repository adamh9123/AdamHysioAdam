      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="border-orange-200 hover:border-orange-300 hover:shadow-lg transition-all duration-300 group cursor-pointer"
                  onClick={() => router.push('/edupack')}>
              <CardHeader className="pb-4">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <CardTitle className="text-hysio-deep-green text-xl">Hysio EduPack</CardTitle>
                    <div className="text-hysio-deep-green/60 text-sm">Patiënt Educatie</div>
                  </div>
                </div>
                <CardDescription className="text-base">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm text-hysio-deep-green-900/80">
                    <CheckCircle className="h-4 w-4 text-hysio-emerald" />
                    <span>B1-niveau Nederlandse educatie</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-hysio-deep-green-900/80">
                    <CheckCircle className="h-4 w-4 text-hysio-emerald" />
                    <span>Automatische context-analyse</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-hysio-deep-green-900/80">
                    <CheckCircle className="h-4 w-4 text-hysio-emerald" />
                    <span>PDF export & email distributie</span>
                  </div>
                </div>
                <div className="mt-4 pt-4 border-t border-orange-100">
                  <div className="text-sm font-medium text-orange-600">
                    🎓 Nieuw: Patiënt educatie generator →
                  </div>
                </div>
              </CardContent>
            </Card>
