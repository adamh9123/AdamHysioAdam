...
// Specialized GPT-4 integration for B1-level Dutch patient education content
...
export class EduPackContentGenerator {
  ...
  private async generateSection(
    ...
    try {
      const systemPrompt = this.buildSystemPrompt(sectionType, context);
  ...
  private buildSystemPrompt(sectionType: EduPackSectionType, context: GenerationContext): string {
